...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`
	AppInfo  int32  `protobuf:"varint,3,opt,name=app_info,json=appInfo,proto3" json:"app_info,omitempty"`
}
...
func (x *LoginRequest) GetAppInfo() int32 {
	if x != nil {
		return x.AppInfo
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x61, 0x70, 0x70,
	0x49, 0x6e, 0x66, 0x6f, 0x22, 0x25, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73,
